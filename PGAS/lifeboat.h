...
typedef HANDLE lifeboat_thread_t;
typedef CRITICAL_SECTION lifeboat_mutex_t;
typedef CONDITION_VARIABLE lifeboat_cond_t;

#define LIFEBOAT_THREAD_RETURN DWORD WINAPI
#define LIFEBOAT_THREAD_RETURN_VALUE 0
#else
#include <pthread.h>

typedef pthread_t lifeboat_thread_t;
typedef pthread_mutex_t lifeboat_mutex_t;
typedef pthread_cond_t lifeboat_cond_t;

#define LIFEBOAT_THREAD_RETURN void *
#define LIFEBOAT_THREAD_RETURN_VALUE NULL
#endif
...
#define LIFEBOAT_ALIGN 64
    ...
    typedef struct
    {
        ...
        /* Thread management (cross-platform) */
        lifeboat_thread_t worker_thread;
        lifeboat_mutex_t mutex;
        lifeboat_cond_t cond_start;
        lifeboat_cond_t cond_done;
