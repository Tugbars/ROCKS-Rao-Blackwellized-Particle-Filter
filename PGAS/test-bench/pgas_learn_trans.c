...
int main(int argc, char **argv)
{
    ...
    /* Set transition prior: κ=100 + adaptive */
    pgas_mkl_set_transition_prior(pgas, 1.0f, 100.0f);
    pgas_mkl_enable_adaptive_kappa(pgas, 1);
    pgas_mkl_configure_adaptive_kappa(pgas, 30.0f, 300.0f, 0.0f, 0.0f);
    ...
    float avg_diag = (trans_learned[0] + trans_learned[5] + 
                      trans_learned[10] + trans_learned[15]) / 4.0f;
