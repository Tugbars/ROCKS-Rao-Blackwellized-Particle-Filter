...
static int oracle_stack_init(OracleStack *stack, int K, int N, int T_max)
{
    ...
    return oracle_bridge_init(&stack->bridge, &bcfg,
                              &stack->hawkes, NULL, &stack->blender, stack->pgas);
}
