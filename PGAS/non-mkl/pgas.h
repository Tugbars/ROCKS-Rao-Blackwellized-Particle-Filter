 ...
 *
 * Performance (measured on modern x86):
 *   ┌────────────────────────────────────────────────────┐
 *   │ Config       │ PGAS    │ PARIS   │ Total  │ Note  │
 *   ├────────────────────────────────────────────────────┤
 *   │ T=100, N=50  │ 1.8ms   │ 6ms     │ 8ms    │ Fast  │
 *   │ T=100, N=100 │ 4.4ms   │ 24ms    │ 28ms   │ OK    │
 *   │ T=200, N=100 │ 8.7ms   │ 49ms    │ 57ms   │ Limit │
 *   │ T=500, N=100 │ 22ms    │ 122ms   │ 144ms  │ Slow  │
 *   └────────────────────────────────────────────────────┘
 *
 * Recommendation: Use T ≤ 200, N = 50-100 for < 50ms background latency.
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 */
