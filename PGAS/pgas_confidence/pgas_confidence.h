 ...
 *
 * NOTE: Requires pgas_mkl.h to be included before this header.
 *       The typedef PGASMKLState is an anonymous struct, so forward
 *       declaration doesn't work. Include pgas_mkl.h first.
 */
#ifdef PGAS_MKL_H /* Only available if pgas_mkl.h is included */
