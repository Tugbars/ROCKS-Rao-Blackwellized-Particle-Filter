...
/**
 * Default: Sleeping Storvik with recommended intervals.
 *   R0 (calm): sample every 50 ticks
 *   R1: sample every 20 ticks
 *   R2: sample every 5 ticks  
 *   R3 (crisis): sample every tick
 */
