...
#define ONLINE_VI_MAX_REGIMES 8
     ...
     *
     * Returns 1 - (variance_sum / max_variance_sum).
    ...
    /**
     * @brief Get normalized entropy (always positive)
     *
     * Returns uncertainty measure in [0, 1]:
     *   0 = completely certain
     *   1 = maximum uncertainty (uniform)
     *
     * Better for triggering than raw Dirichlet entropy (which can be negative).
     *
     * @param vi    Online VI structure
